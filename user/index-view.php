...
<head>
    ...
    <style>
        body {
            ...
            background-position: center center; /* Centra la imagen en el viewport */
        }
        
        .contenido {
    padding: 10px;
    border-radius: 10px;
    margin: 200px auto; /* Centra el contenido horizontalmente */
    color: #fff; /* Cambiado a texto blanco para que sea legible en fondo oscuro */
    width: fit-content;
    background-color: rgba(4, 13, 18, 0.8); /* Fondo semitransparente */
}
    </style>
</head>
<body>
