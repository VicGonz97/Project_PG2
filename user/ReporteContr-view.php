        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    <legend class="text-center" style="color: gray;">"Listado de los contribuyentes."</legend>
                    <a href="./lib/pdf_contribuyente.php" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-print" aria-hidden="true"></i> Generar PDF</a>
                </ul>
            </div>
        </div>
        <br>
