                ...
                <div class="panel-body">
                    <form role="form" action="" method="POST">
                        ...
                        <div class="form-group has-success has-feedback">
                            ...
                            <input type="text" id="input_user" class="form-control" name="user_reg" placeholder="Nombre de usuario" required="" pattern="[a-zA-Z0-9]{1,15}" title="Ejemplo7 máximo 15 caracteres" maxlength="15">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="telefono_reg" placeholder="00000000" required="" pattern="[0-9]{8}" title="Ocho dígitos numéricos">
                        </div>
                        <div class="form-group">
                            <label><i class="fa fa-id-card"></i>&nbsp;DPI</label>
                            <input type="text" class="form-control" name="dpi_reg" placeholder="0000000000000" required="" pattern="[0-9]{13}" title="Trece dígitos numéricos">
                        </div>
                        <div class="form-group">
